...
namespace KS.Reactor.Client.Unity
{
    ...
    public class ksPrefabCache
    {
        ...
        public ksPrefabCache(Dictionary<string, AssetBundle> assetBundles)
        {
        ...
        public GameObject GetPrefab(uint assetId, string entityType)
        {
            ...
            if (HasChildEntity(prefab.transform))
            {
                ...
                prefab.transform.parent = m_container.transform;
            }
        ...
        /// <param name="assetId">Asset id.</param>
        /// <param name="entityType">Entity type.</param>
        public void RegisterEntityType(uint assetId, string entityType)
        {
            string oldPath;
