    ...
    public class ksReactorConfigEditor : UnityEditor.Editor, IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        private void OnPropertyChange()
        {
            switch (m_changedPropertyName)
            {
                ...
                case "DefaultServerGhostMaterial":
                case "DefaultServerGhostColor":
                {
                    ...
                    {
                        ksBaseRoom<ksPlayer, ksEntity> room = baseRoom as ksBaseRoom<ksPlayer, ksEntity>;
                        if (room == null)
                        {
                            continue;
                        }

                        foreach (ksEntity entity in room.ServerGhostEntities)
                        {
                            entity.ApplyServerGhostMaterial();
                        }
                    }
                    break;
                }
