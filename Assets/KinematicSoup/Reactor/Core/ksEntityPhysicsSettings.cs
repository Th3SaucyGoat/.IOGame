...
namespace KS.Reactor.Client.Unity
{
    ...
    {
        /// <summary>
        /// Rigid body types shown in the inspector. This is the same as <see cref="ksRigidBodyTypes"/>, but without
        /// the <see cref="ksRigidBodyTypes.DEFAULT"/> option so it cannot be selected in the inspector. We also use
        ...
        /// </summary>
        private enum RigidBodyTypes
        {
            [InspectorName("3D")]
            RIGID_BODY_3D = ksRigidBodyTypes.RIGID_BODY_3D,
            [InspectorName("2D")]
            RIGID_BODY_2D = ksRigidBodyTypes.RIGID_BODY_2D
        }
        ...
        public ksRigidBodyTypes RigidBodyType
        {
            get { return (ksRigidBodyTypes)m_rigidBodyType; }
            set { m_rigidBodyType = (RigidBodyTypes)value; }
        }

        /// <summary>Is the rigid body 3D or 2D?</summary>
        [Tooltip("Is the rigid body 3D or 2D? (Unchecked = Use default room settings)")]
        [SerializeField]
        private RigidBodyTypes m_rigidBodyType = RigidBodyTypes.RIGID_BODY_3D;
        ...
        public ksEntityPhysicsSettings(
            ...
            ksRigidBodyTypes type = ksRigidBodyTypes.RIGID_BODY_3D)
        {
