...
namespace KS.Reactor.Client.Unity
{
    ...
    public class ksPlayer : ksBasePlayer, ksPlayer.IInternals
    {
        /// <summary>
        /// Explicit interface definition. Methods defined in this interface will only be accessible when 
        /// <see cref="ksPlayer"/> instances are cast to this interface.
        /// </summary>
        public interface IInternals
        {
            void SetGameObject(GameObject gameObject);
            bool ValidateScript(ksPlayerScript script);
        }
        ...
        void IInternals.SetGameObject(GameObject gameObject)
        {
        ...
        bool IInternals.ValidateScript(ksPlayerScript script)
        {
