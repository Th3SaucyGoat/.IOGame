...
namespace KS.Reactor.Client.Unity.Editor
{
    ...
    public class ksLocalServerMenu : EditorWindow
    {
        ...
        private void GetPublishedScenes()
        {
            ...
            string[] files = Directory.GetFiles(ksPaths.BuildDir, "config.*.json", SearchOption.TopDirectoryOnly);
        ...
        private void SetSceneAndRoom(string scene, string room, string protocol)
        {
            ...
            string[] rooms = null;
            if (!string.IsNullOrEmpty(room) && m_sceneRooms.TryGetValue(scene, out rooms))
            {
