...
namespace KS.Reactor.Client.Unity.Editor
{
    ...
    public class ksLocalServer
    {
        ...
        public void StartInstance(string scene, string room, ushort port, string protocol = "tcp")
        {
            ...
            if (!ksReactorMenu.CheckInstallationPath())
            {
                ksLog.Warning(this, "Unable to locate the local Reactor server");
                return;
            }
            ...
            if (ksPaths.OperatingSystem == "Unix")
            {
                ...
                arguments = "\"" + ksReactorConfig.Instance.Server.ServerPath + "Reactor.exe\"";
            }
            else
            {
                fileName = ksReactorConfig.Instance.Server.ServerPath + "Reactor.exe";
                arguments = "";
            }
            string workingDirectory = ksPaths.BuildDir;
            ...
            string protocol = "tcp")
        {
            ...
            if (!ksReactorMenu.CheckInstallationPath())
            {
                ksLog.Warning(this, "Unable to locate the local KSCluster server");
                return;
            }
            ...
            try
            {
                ...
                clusterConfig["server path"] = ksPathUtils.ToAbsolutePath(ksReactorConfig.Instance.Server.ServerPath);
            ...
            {
                fileName = ksPaths.ClusterDir + "KSCluster.exe";
                arguments = "";
            }
            string workingDirectory = ksPaths.ClusterDir;
