...
{
    /// <summary>Cone collider component.</summary>
    [AddComponentMenu("Physics/Cone Collider", -1)]
    public class ksConeCollider : MonoBehaviour, ksIUnityCollider
    {
        ...
        /// <summary>The collider component this interface is for.</summary>
        ...
        /// <summary>Cone height. Negative to invert the cone.</summary>
        public float Height
        {
            get { return m_height; }
            set { m_height = value; }
        ...
        public void Start()
        {
            ...
            m_childCollider.sharedMesh = ksConeMeshFactory.GetMesh(m_radius, m_height, m_direction, m_numSides);
        ...
        /// <summary>Volume of the cone.</summary>
        /// <returns>Volume</returns>
        public float Volume()
        {
            return (float)Math.PI * m_radius * m_radius * m_height / 3f;
        }

        /// <summary>The geometric center of the cone in local space.</summary>
        ...
        public Vector3 GeometricCenter()
        {
            ...
            return m_center - m_height * direction / 4f;
        }
        ...
        /// <summary>Serializes the cone collider by generating convex hull vertices.</summary>
        /// <returns>Serialized geometry</returns>
        public byte[] Serialize()
        {
            Vector3[] vertices = ksConeMeshFactory.GenerateVertices(m_radius, m_height, m_direction, m_numSides);
        ...
        public bool IsGeometryEqual(ksIUnityCollider other)
        {
            ...
            ksConeCollider b = (ksConeCollider)other;
